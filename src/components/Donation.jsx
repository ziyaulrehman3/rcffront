    ...
    <div className="donation-page bg-[#D9D9D9] container mx-auto mt-8">
      <div className="flex flex-col md:flex-row  gap-4">
        ...
        <div className="w-full md:w-1/2">
          <img
            ...
            alt="Donation"
            className="aspect-square  w-4/5 mx-auto h-auto object-cover bg-strokeyellow"
          />
        </div>
        ...
        <div className="w-4/5 md:w-1/2 py-10 flex flex-col items-start justify-between px-4">
          ...
          <div className="w-full border rounded-md h-2/3">
            {selectedOption === "upi" ? (
              <div className='h-full w-11/12'>
                <h3 className="text-xl font-semibold mb-2">UPI Details:</h3>
                <p className="text-base font-semibold">UPI ID: raaht89584648@barodampay</p><br/>
                <img className="h-48 aspect-square" src="https://res.cloudinary.com/dqxjfn0qw/image/upload/v1740940676/qrcode_kmul7o.png" alt="qr-code" />
              </div>
            ) : (
              ...
              <div>
                ...
                <p className="text-base font-semibold">
                  ...
                  Account Number: 05850200000648<br />
                  IFSC: BARB0VJRAMP<br/>
      ...
      <div className="my-4">
        <p className="font-poppins bg-slate-600 text-slate-50 text-center md:text-center w-full px-4 mx-auto">
          Send your payments screenshot to get the Donation receipt on Our WhatsApp Number:
          9876543210
        </p>
      </div>
