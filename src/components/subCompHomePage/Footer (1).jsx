    ...
    <div className="bg-black gap-8 text-white flex flex-col justify-between p-10">
      <div className="flex flex-col sm:flex-row justify-evenly gap-1">
        ...
        <div className="section-header flex flex-col gap-2">
          ...
          >
            ...
            <Icon
              icon={
                openSection === "about" ? "bx:chevron-up" : "bx:chevron-down"
              }
        ...
        <div className="section-header flex flex-col gap-2">
          ...
          >
            ...
            <Icon
              icon={
                openSection === "legal" ? "bx:chevron-up" : "bx:chevron-down"
              }
              className="ml-2 w-4 h-4 sm:hidden"
            />
          </h2>
        ...
        <div className="section-header flex flex-col gap-2">
          ...
          >
            ...
            <Icon
              icon={
                openSection === "work" ? "bx:chevron-up" : "bx:chevron-down"
              }
              className="ml-2 w-4 h-4 sm:hidden"
            />
          </h2>
        ...
        <div className="section-header flex flex-col gap-2">
          ...
          >
            ...
            <Icon
              icon={
                openSection === "support" ? "bx:chevron-up" : "bx:chevron-down"
              }
              className="ml-2 w-4 h-4 sm:hidden"
            />
          </h2>
      ...
      <div className="flex justify-center gap-8">
        ...
        >
          <img
            className="w-8 p-1 bg-white rounded-md hover:bg-blue-500 transition-all ease-linear"
            src="https://res.cloudinary.com/dqxjfn0qw/image/upload/v1741407276/instagram_bhgqdc.png"
            alt="instagram-icon"
          />
        </Link>
        <Link
