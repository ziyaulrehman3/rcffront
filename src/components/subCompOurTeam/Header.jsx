...
const Header = () => {
  return (
    <div className="text-center my-[5%] w-full">
      ...
      <p className="text-[#E3501F] text-xl font-poppins font-normal mt-2 py-2 px-2">Passionate Minds, United for a Cause</p>
      <p className="text-[#9CA3AF]  gap-0 font-poppins w-[85%]  h-[75px] mx-auto flex items-center justify-center text-base lg:w-2/3">
